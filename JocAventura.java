...
public class JocAventura {
    ...
    private boolean executarComanda(String[] parts) {
        boolean actiu = true;
        switch (parts[0]) {
            @@ -72,11 +54,9 @@ private boolean executarComanda(String[] parts) {
            ...
            case "agafar":
                ...
                if (itemHabitacio != null) {
                    @@ -90,24 +70,9 @@ private boolean executarComanda(String[] parts) {
                    ...
                    case "ajuda":
                        ...
                        @@ -116,44 +81,11 @@ private boolean executarComanda(String[] parts) {
